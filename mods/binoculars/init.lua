...
local S = MultiCraft.get_translator("binoculars")
...
function binoculars.update_player_property(player)
	...
	if player:get_inventory():contains_item(
		...
		new_zoom_fov = 10
	elseif MultiCraft.is_creative_enabled(player:get_player_name()) then
		new_zoom_fov = 15
	end
...
local function cyclic_update()
	...
	MultiCraft.after(4.7, cyclic_update)
end
...
MultiCraft.register_craftitem("binoculars:binoculars", {

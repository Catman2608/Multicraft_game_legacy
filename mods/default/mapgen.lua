...
MultiCraft.register_alias("mapgen_river_water_source", "default:river_water_source")
...
MultiCraft.register_alias("mapgen_desert_stone", "default:desert_stone")
MultiCraft.register_alias("mapgen_desert_sand", "default:desert_sand")
...
MultiCraft.register_alias("mapgen_apple", "default:apple")
...
MultiCraft.register_alias("mapgen_pine_tree", "default:pine_tree")
MultiCraft.register_alias("mapgen_pine_needles", "default:pine_needles")

MultiCraft.register_alias("mapgen_cobble", "default:cobble")
MultiCraft.register_alias("mapgen_stair_cobble", "stairs:stair_cobble")
MultiCraft.register_alias("mapgen_mossycobble", "default:mossycobble")
MultiCraft.register_alias("mapgen_stair_desert_stone", "stairs:stair_desert_stone")
...
function default.register_decorations()
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/apple_tree.mts",
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/apple_log.mts",
	...
	local chunksize = tonumber(MultiCraft.get_mapgen_setting("chunksize"))
	if chunksize >= 5 then
		MultiCraft.register_decoration({
			...
			y_max = 32,
			y_min = 1,
			schematic = MultiCraft.get_modpath("default") ..
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/jungle_tree.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/jungle_log.mts",
		flags = "place_center_x",
		rotation = "random",
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/pine_tree.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/small_pine_tree.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/pine_log.mts",
		flags = "place_center_x",
		rotation = "random",
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/acacia_tree.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/acacia_log.mts",
		flags = "place_center_x",
		rotation = "random",
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/aspen_tree.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/aspen_log.mts",
		flags = "place_center_x",
		rotation = "random",
		spawn_by = "default:dirt_with_grass",
		num_spawn_by = 8,
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/large_cactus.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 0,
		y_min = 0,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/papyrus_on_dirt.mts",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/bush.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	MultiCraft.register_decoration({
		...
		y_min = 1,
		place_offset_y = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/blueberry_bush.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/acacia_bush.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	MultiCraft.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = MultiCraft.get_modpath("default") .. "/schematics/pine_bush.mts",
		flags = "place_center_x, place_center_z",
	})
...
MultiCraft.clear_registered_biomes()
MultiCraft.clear_registered_ores()
MultiCraft.clear_registered_decorations()

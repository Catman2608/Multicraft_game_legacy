...
MultiCraft.register_node("default:stone_block", {
...
MultiCraft.register_node("default:desert_stone", {
...
MultiCraft.register_node("default:desert_cobble", {
...
MultiCraft.register_node("default:desert_stonebrick", {
...
MultiCraft.register_node("default:desert_stone_block", {
...
MultiCraft.register_node("default:sandstonebrick", {
...
MultiCraft.register_node("default:sandstone_block", {
...
MultiCraft.register_node("default:desert_sandstone", {
...
MultiCraft.register_node("default:desert_sandstone_brick", {
...
MultiCraft.register_node("default:desert_sandstone_block", {
...
MultiCraft.register_node("default:silver_sandstone", {
...
MultiCraft.register_node("default:silver_sandstone_brick", {
...
MultiCraft.register_node("default:silver_sandstone_block", {
...
MultiCraft.register_node("default:obsidianbrick", {
...
MultiCraft.register_node("default:obsidian_block", {
...
MultiCraft.register_node("default:dirt_with_dry_grass", {
...
MultiCraft.register_node("default:dirt_with_rainforest_litter", {
...
MultiCraft.register_node("default:dirt_with_coniferous_litter", {
...
MultiCraft.register_node("default:dry_dirt", {
...
MultiCraft.register_node("default:dry_dirt_with_dry_grass", {
...
MultiCraft.register_node("default:permafrost", {
...
MultiCraft.register_node("default:permafrost_with_stones", {
...
MultiCraft.register_node("default:permafrost_with_moss", {
...
MultiCraft.register_node("default:desert_sand", {
...
MultiCraft.register_node("default:silver_sand", {
...
MultiCraft.register_node("default:cave_ice", {
...
MultiCraft.register_node("default:apple", {
	...
	after_place_node = function(pos, placer, itemstack)
		MultiCraft.set_node(pos, {name = "default:apple", param2 = 1})
	end,

	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		if oldnode.param2 == 0 then
			MultiCraft.set_node(pos, {name = "default:apple_mark"})
			MultiCraft.get_node_timer(pos):start(math.random(300, 1500))
		end
	end,
})

MultiCraft.register_node("default:apple_mark", {
	...
	on_timer = function(pos, elapsed)
		if not MultiCraft.find_node_near(pos, 1, "default:leaves") then
			MultiCraft.remove_node(pos)
		elseif MultiCraft.get_node_light(pos) < 11 then
			MultiCraft.get_node_timer(pos):start(200)
		else
			MultiCraft.set_node(pos, {name = "default:apple"})
		end
	end
})
...
MultiCraft.register_node("default:emergent_jungle_sapling", {
...
MultiCraft.register_node("default:pine_tree", {
...
MultiCraft.register_node("default:pine_wood", {
...
MultiCraft.register_node("default:pine_sapling", {
...
MultiCraft.register_node("default:acacia_tree", {
...
MultiCraft.register_node("default:acacia_wood", {
...
MultiCraft.register_node("default:acacia_leaves", {
...
MultiCraft.register_node("default:acacia_sapling", {
...
MultiCraft.register_node("default:aspen_tree", {
...
MultiCraft.register_node("default:aspen_wood", {
...
MultiCraft.register_node("default:aspen_leaves", {
...
MultiCraft.register_node("default:aspen_sapling", {
...
MultiCraft.register_node("default:coalblock", {
...
MultiCraft.register_node("default:stone_with_copper", {
...
MultiCraft.register_node("default:copperblock", {
...
MultiCraft.register_node("default:stone_with_tin", {
...
MultiCraft.register_node("default:tinblock", {
...
MultiCraft.register_node("default:bronzeblock", {
...
MultiCraft.register_node("default:stone_with_mese", {
...
MultiCraft.register_node("default:mese", {
...
MultiCraft.register_node("default:large_cactus_seedling", {
	...
	on_construct = function(pos)
		...
		MultiCraft.get_node_timer(pos):start(math.random(1859, 3719))
	end,

	on_timer = function(pos)
		local node_under = MultiCraft.get_node_or_nil(
		...
		if MultiCraft.get_item_group(node_under.name, "sand") == 0 then
			-- Seedling dies
			MultiCraft.remove_node(pos)
			return
		end
		...
		MultiCraft.log("action", "A large cactus seedling grows into a large" ..
			"cactus at ".. MultiCraft.pos_to_string(pos))
		default.grow_large_cactus(pos)
	end,
})

MultiCraft.register_node("default:papyrus", {
...
MultiCraft.register_node("default:grass_1", {
	description = S("Grass"),
	drawtype = "plantlike",
	waving = 1,
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local ret = MultiCraft.item_place(stack, placer, pointed_thing)
...
for i = 2, 5 do
	MultiCraft.register_node("default:grass_" .. i, {
		description = S("Grass"),
		drawtype = "plantlike",
		waving = 1,
...
MultiCraft.register_node("default:dry_grass_1", {
...
for i = 2, 5 do
	MultiCraft.register_node("default:dry_grass_" .. i, {
		description = S("Savanna Grass"),
		drawtype = "plantlike",
		waving = 1,
...
MultiCraft.register_node("default:fern_1", {
	description = S("Fern"),
	drawtype = "plantlike",
	waving = 1,
...
for i = 2, 3 do
	MultiCraft.register_node("default:fern_" .. i, {
		description = S("Fern"),
		drawtype = "plantlike",
		waving = 1,
		visual_scale = 2,
...
MultiCraft.register_node("default:marram_grass_1", {
...
for i = 2, 3 do
	MultiCraft.register_node("default:marram_grass_" .. i, {
		description = S("Marram Grass"),
		drawtype = "plantlike",
		waving = 1,
...
MultiCraft.register_node("default:bush_stem", {
...
MultiCraft.register_node("default:bush_leaves", {
...
MultiCraft.register_node("default:bush_sapling", {
...
MultiCraft.register_node("default:blueberry_bush_leaves_with_berries", {
	...
	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		MultiCraft.set_node(pos, {name = "default:blueberry_bush_leaves"})
		MultiCraft.get_node_timer(pos):start(math.random(300, 1500))
	end,
})

MultiCraft.register_node("default:blueberry_bush_leaves", {
	...
	on_timer = function(pos, elapsed)
		if MultiCraft.get_node_light(pos) < 11 then
			...
			MultiCraft.set_node(pos, {name = "default:blueberry_bush_leaves_with_berries"})
		end
	end,
...
MultiCraft.register_node("default:blueberry_bush_sapling", {
...
MultiCraft.register_node("default:acacia_bush_stem", {
...
MultiCraft.register_node("default:acacia_bush_leaves", {
...
MultiCraft.register_node("default:acacia_bush_sapling", {
...
MultiCraft.register_node("default:pine_bush_stem", {
...
MultiCraft.register_node("default:pine_bush_needles", {
...
MultiCraft.register_node("default:pine_bush_sapling", {
...
MultiCraft.register_node("default:sand_with_kelp", {
	description = S("Kelp"),
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if pointed_thing.type == "node" and placer and
			...
			local node_ptu = MultiCraft.get_node(pointed_thing.under)
			local def_ptu = MultiCraft.registered_nodes[node_ptu.name]
		...
		if MultiCraft.get_node(pos).name ~= "default:sand" then
			return itemstack
		end

		local height = math.random(4, 6)
		local pos_top = {x = pos.x, y = pos.y + height, z = pos.z}
		local node_top = MultiCraft.get_node(pos_top)
		local def_top = MultiCraft.registered_nodes[node_top.name]
		local player_name = placer:get_player_name()

		if def_top and def_top.liquidtype == "source" and
				MultiCraft.get_item_group(node_top.name, "water") > 0 then
			if not MultiCraft.is_protected(pos, player_name) and
					not MultiCraft.is_protected(pos_top, player_name) then
				MultiCraft.set_node(pos, {name = "default:sand_with_kelp",
					param2 = height * 16})
				if not MultiCraft.is_creative_enabled(player_name) then
					itemstack:take_item()
				end
			else
				MultiCraft.chat_send_player(player_name, "Node is protected")
	...
	after_destruct  = function(pos, oldnode)
		MultiCraft.set_node(pos, {name = "default:sand"})
	end
})
...
local function coral_on_place(itemstack, placer, pointed_thing)
	...
	local node_under = MultiCraft.get_node(pos_under)
	...
	if node_under.name ~= "default:coral_skeleton" or
			MultiCraft.get_node(pos_above).name ~= "default:water_source" then
		return itemstack
	end

	if MultiCraft.is_protected(pos_under, player_name) or
			MultiCraft.is_protected(pos_above, player_name) then
		MultiCraft.log("action", player_name
			.. " tried to place " .. itemstack:get_name()
			.. " at protected position "
			.. MultiCraft.pos_to_string(pos_under))
		MultiCraft.record_protection_violation(pos_under, player_name)
		return itemstack
	end

	node_under.name = itemstack:get_name()
	MultiCraft.set_node(pos_under, node_under)
	if not MultiCraft.is_creative_enabled(player_name) then
		itemstack:take_item()
	end
...
MultiCraft.register_node("default:coral_green", {
	...
	after_destruct  = function(pos, oldnode)
		MultiCraft.set_node(pos, {name = "default:coral_skeleton"})
	end,
})

MultiCraft.register_node("default:coral_pink", {
...
MultiCraft.register_node("default:coral_cyan", {
...
MultiCraft.register_node("default:coral_brown", {
...
MultiCraft.register_node("default:coral_orange", {
...
MultiCraft.register_node("default:coral_skeleton", {
...
MultiCraft.register_node("default:river_water_source", {
...
MultiCraft.register_node("default:river_water_flowing", {
...
MultiCraft.register_node("default:bookshelf", {
	...
	allow_metadata_inventory_put = function(pos, listname, index, stack)
		if MultiCraft.get_item_group(stack:get_name(), "book") ~= 0 then
	...
	on_metadata_inventory_move = function(pos, from_list, from_index, to_list, to_index, count, player)
		MultiCraft.log("action", player:get_player_name() ..
			" moves stuff in bookshelf at " .. MultiCraft.pos_to_string(pos))
		update_bookshelf(pos)
	end,
	on_metadata_inventory_put = function(pos, listname, index, stack, player)
		MultiCraft.log("action", player:get_player_name() ..
			" puts stuff to bookshelf at " .. MultiCraft.pos_to_string(pos))
		update_bookshelf(pos)
	end,
	on_metadata_inventory_take = function(pos, listname, index, stack, player)
		MultiCraft.log("action", player:get_player_name() ..
			" takes stuff from bookshelf at " .. MultiCraft.pos_to_string(pos))
		update_bookshelf(pos)
	end,
...
local function register_sign(material, desc, def)
	MultiCraft.register_node("default:sign_wall_" .. material, {
		description = desc,
		drawtype = "nodebox",
		...
		on_receive_fields = function(pos, formname, fields, sender)
			...
			if string.len(text) > 512 then
				MultiCraft.chat_send_player(player_name, S("Text too long"))
				return
			end
			MultiCraft.log("action", player_name .. " wrote \"" .. text ..
				"\" to the sign at " .. MultiCraft.pos_to_string(pos))
			local meta = MultiCraft.get_meta(pos)
...
MultiCraft.register_node("default:ladder_wood", {
...
MultiCraft.register_node("default:ladder_steel", {
...
MultiCraft.register_node("default:obsidian_glass", {
...
MultiCraft.register_node("default:meselamp", {

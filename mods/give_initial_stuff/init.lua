...
local stuff_string = MultiCraft.settings:get("initial_stuff") or
...
if MultiCraft.settings:get_bool("give_initial_stuff") then
	MultiCraft.register_on_newplayer(give_initial_stuff.give)
end

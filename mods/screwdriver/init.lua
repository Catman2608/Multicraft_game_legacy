...
local S = MultiCraft.get_translator("screwdriver")
...
-- simplified version of MultiCraft:builtin/game/falling.lua#L148.
local function check_attached_node(pos, rotation)
	local d = MultiCraft.wallmounted_to_dir(rotation)
	local p2 = vector.add(pos, d)
	local n = MultiCraft.get_node(p2).name
	local def2 = MultiCraft.registered_nodes[n]
...
screwdriver.rotate.wallmounted = function(pos, node, mode)
	...
	if MultiCraft.get_item_group(node.name, "attached_node") ~= 0 then
...
-- Screwdriver
MultiCraft.register_tool("screwdriver:screwdriver", {
...
MultiCraft.register_alias("screwdriver:screwdriver1", "screwdriver:screwdriver")
MultiCraft.register_alias("screwdriver:screwdriver2", "screwdriver:screwdriver")
MultiCraft.register_alias("screwdriver:screwdriver3", "screwdriver:screwdriver")
MultiCraft.register_alias("screwdriver:screwdriver4", "screwdriver:screwdriver")
